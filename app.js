...
const I18N = {
  fr: {
    ...
    "home.aboutText": "Nous sommes une équipe qui utilise la technologie pour améliorer le suivi des patients, aider les médecins à prendre de meilleures décisions et rendre les patients acteurs de leur santé, tout en renforçant une relation médecin–patient plus continue et personnalisée.",
  ...
  ar: {
    ...
    "home.aboutTitle": "Smart Patient Monitoring",
    "home.aboutText": "نحن فريق يستخدم التكنولوجيا لتحسين تتبع المرضى، مساعدة الأطباء على اتخاذ قرارات أفضل وجعل المرضى فاعلين في صحتهم، مع تعزيز علاقة طبيب ومريض أكثر استمرارا وشخصية.",
